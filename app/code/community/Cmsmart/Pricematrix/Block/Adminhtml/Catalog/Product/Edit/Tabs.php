 ...
 */
class Cmsmart_Pricematrix_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tabs{
    ...
    protected function _prepareLayout()
    {
        if(Mage::helper('cmsmart_pricematrix')->isEnabled()){
            ...
            if ($setId) {
                ...
                // thanh
                $this->addTab('pricematrix', array(
                    'label' => Mage::helper('catalog')->__('Price Matrix'),
                    'url'   => $this->getUrl('*/*/pricematrix', array('_current' => true)),
                    'class' => 'ajax',
                ));
