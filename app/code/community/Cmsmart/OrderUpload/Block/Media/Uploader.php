 ...
 */
class Cmsmart_OrderUpload_Block_Media_Uploader extends Mage_Adminhtml_Block_Widget
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('orderupload/uploader.phtml');
        $this->getConfig()->setUrl(Mage::getModel('adminhtml/url')->addSessionParam()->getUrl('orderupload/gallery/upload'));
    ...
    {
    	//$data=Mage::helper('core')->jsonEncode($this->getConfig()->getData());
    ...
    public function getDataMaxSize()
    {
        ...
        $size=Mage::getStoreConfig('orderupload/general/max_size');
        
        if(($size != '')&&($size != '0'))
        	$size=$size.'M';
        else
        	$size=min($this->getPostMaxSize(), $this->getUploadMaxSize());
