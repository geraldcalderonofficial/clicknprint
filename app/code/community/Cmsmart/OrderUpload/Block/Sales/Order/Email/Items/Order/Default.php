 ...
 */
class Cmsmart_OrderUpload_Block_Sales_Order_Email_Items_Order_Default extends Mage_Sales_Block_Order_Email_Items_Order_Default
{
    /**
    ...
    {
    	//echo 'fdsa..fsdfds...';die;
    	
    	//echo 'kiendt error';die;
    	$proid=$this->getItem()->getProduct()->getId();
    	//Zend_Debug::dump($proid);exit();
    	$orderidFull = Mage::getModel("sales/order")->getCollection()->getLastItem()->getIncrementId();
    	...
    	if(!empty($arr_img))
    	{
    		...
    		$div_img.='<br/>';
    		$div_img.='<table  border="0" cellspacing="0" cellpadding="0">';
    			$div_img.='<thead>';
	    			$div_img.='<tr>';
