...
//                    toggleShowTool();
    ...
    $('#dag-files-images, #uploaded-facebook, #nbdesigner_art_container, #nbdesigner_font_container, .nbdesigner_config_svg, #pattern-boddy, #tool-help, #design-help, #general-help').perfectScrollbar();   
