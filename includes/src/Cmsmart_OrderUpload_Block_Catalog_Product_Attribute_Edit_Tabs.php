 ...
 */
class Cmsmart_OrderUpload_Block_Catalog_Product_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('orderupload/catalog_product_attribute_edit_tab_main')->toHtml(),
            'active'    => true
        ));
